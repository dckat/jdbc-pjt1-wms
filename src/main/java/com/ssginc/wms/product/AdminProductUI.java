...
public class AdminProductUI extends JFrame {
    ...
    public AdminProductUI(String id) {
        ...
        welcomeLabel = new
                ...
                JLabel("< " + id + " > 님 환영합니다.", SwingConstants.RIGHT);
        ...
        invenUIButton.addActionListener(e -> JOptionPane.showMessageDialog(this, "재고 현황 버튼 클릭됨"));
        ...
        purordButton.addActionListener(e -> JOptionPane.showMessageDialog(this, "발주 관리 버튼 클릭됨"));
